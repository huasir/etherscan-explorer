 ...
 */
public class ConverterFunctionUtil {
    public static Function<EthBlock.Block, Block> toDbBlock
    ...
    public static Function<EthBlock.Block, List<Transaction>> toTransactions
    ...
    public static Function<EthBlock.Block, List<Account>> toAccounts
            = blk -> {
    ...
    public static Function<List<org.web3j.protocol.core.methods.response.Transaction>, List<Transaction>> toPendingTransaction
            = txs -> txs.stream()
